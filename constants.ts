...
export const MOCK_ISSUES: GUTIssue[] = [
  {
    ...
    immediateAction: 'Realizar bypass parcial e solicitar troca imediata do elemento filtrante.',
  ...
  },
  {
    ...
    immediateAction: 'Monitoramento de vibração a cada 4h e análise de óleo programada.',
  ...
  },
  {
    ...
    immediateAction: 'Verificar pré-filtros de 1 micron.',
