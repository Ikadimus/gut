                ...
                <div className="space-y-6">
                  {showForm ? (
                    ...
                    <SectorPortal 
                      ...
                      onAdd={currentUser.role !== UserRole.VIEWER ? () => { setCurrentIssue(null); setShowForm(true); } : undefined}
                    />
                  )}
                </div>
              )}
